...
export default function MoC() {
  return (
    <AnimationLayer
      as="main"
      className="flex min-h-screen flex-col items-center justify-between py-20 overflow-x-clip"
      method="rise"
      distance={44}
      duration={760}
      threshold={0.12}
    ...
    >
      <AnimationLayer as="div" className={`mb-6 grid text-center 
        md:grid-cols-2 
        lg:w-half lg:max-w-5xl lg:grid-cols-3 lg:text-left
        `} method="rise" distance={44} stagger={90} staggerCycle={3}>
        <Reveal as="h1" className="text-3xl font-bold text-center mt-8 mb-16 font-nyu-ultra">Made of Chicago</Reveal>
        <Reveal as="p" className="text-xl font-bold text-center mt-8">
