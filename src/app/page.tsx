  ...
  return (
    <HomeClickTracker userLocation={userLocation}>
      <main className="flex min-h-screen flex-col items-center justify-between md:pt-20 mb-32 font-nyu">
        ...
        <div className={cardWrapperStyle}>
          <h2 className="text-xl font-bold text-center capitalize" >Building Bridges. Creating Momentum.</h2>
          <Card
            {...homeCardProps}
          ...
          >
            <div>
              <p className="text-wrap">
                Any sector, any size, one obsession: turning ideas into outcomes. ✨
              </p>
              <ul className="list-disc grid grid-cols-1">
                ...
                <li className="hover:underline justify-start">Student-led projects and career-ready initiatives</li>
                <li className="hover:underline justify-start">Community organizers and mission-driven programming</li>
          </ul>
        </div>
      </Card>
    </div>
        ...
        <div className={cardWrapperStyle}>
          ...
          >
            <ul className="list-disc grid grid-cols-1">
              <li className="text-wrap">Navigate with ease. Use the top menu to jump to specific project categories.</li>
              <li className="text-wrap">Connect &amp; Learn More. Find contact information and additional details in the footer.</li>
            </ul>
          </Card>
        </div>
