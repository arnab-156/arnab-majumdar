...
export default function EyeOnIndia() {
  return (
    ...
    >
      <Reveal as="h1" className="p-4 m-2 bg-white/80 rounded text-center dark:text-black font-bold text-overflow-ellipsis overflow-hidden line-clamp-1">Eye on India - Saree Project</Reveal>
      ...
      <Reveal className="flex overflow-x-auto scroll-smooth m-auto">
      ...
      <Reveal className={`h-80 rounded-md relative bg-cover bg-center
      ...
      <Reveal className={`h-80 rounded-md relative bg-contain bg-center
      ...
      <Reveal className={`h-80 rounded-md relative bg-cover bg-center mt-2
      ...
      <Reveal className={`h-80 rounded-md relative bg-cover bg-contain m-auto w-full md:h-96
