...
export default function LincolnPark() {
  return (
    <AnimationLayer
      as="main"
      className="flex min-h-screen flex-col items-center justify-between pt-20 pb-56 overflow-x-clip"
      method="rise"
      distance={44}
      duration={760}
      threshold={0.12}
    ...
    >
      <AnimationLayer as="div" className="mb-6 grid items-center text-center lg:w-half lg:max-w-5xl lg:grid-cols-3 lg:text-left" method="rise" distance={44} stagger={90} staggerCycle={3}>
        <Reveal as="h1"
          className="p-4 m-2 rounded text-center dark:text-black font-bold text-overflow-ellipsis overflow-hidden line-clamp-2">
          Lincoln Park Conservatory
        </Reveal>

        <Reveal as="p" className="text-xl my-6 max-w-md m-auto text-center">
        ...
        <Reveal as="p" className="text-xl my-6 max-w-md m-auto p-4">
        ...
        <Reveal as="h2" className="p-4 m-2 bg-white/80 rounded text-center dark:text-black font-bold text-overflow-ellipsis overflow-hidden">
