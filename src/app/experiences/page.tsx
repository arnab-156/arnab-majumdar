    ...
    >
      ...
      <section className="relative w-full overflow-hidden bg-lotus-paper text-lotus-ink dark:bg-[#101114] dark:text-lotus-paper py-16 px-6 md:px-12">
        ...
        >
          ...
          {/* Companion panel to the homepage's "New Learnings!" card — same
              shell, carrying the portrait and the LinkedIn link from /about.
              The portrait is round here, as it is on the homepage. */}
