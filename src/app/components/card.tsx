...
export const Card: NextPage<CardProps> = ({
    ...
    const baseClassNames = classNames(
        `card-component mr-4 ml-4 mb-4 rounded shadow-md content-center p-4 bg-gray-200 hover:bg-gray-300 active:bg-gray-400 dark:bg-gray-900`,
        backgroundTheme,
        customClassName
    );
    ...
    return <div className={baseClassNames}>{cardContent}</div>;
}
