...
import { MenuIcon, LotusIcon } from "../icons";
import styles from "./styles.module.css";

export const Navigation = () => {
    return (<nav className={classNames(`flex flex-col items-center justify-between`, styles.navigation)} id="navigation">
        <div className={`z-10 w-full items-center justify-between flex justify-content font-mono text-sm lg:text-transparent hover:lg:text-black dark:hover:lg:text-white lg:shadow-2xl lg:shadow-purple-900/40 hover:lg:shadow-none `}>
