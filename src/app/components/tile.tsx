...
export const Tile: NextPage<MyTileComponent> = ({ title, subTitle, href, url, shadowColor, customClassName, imageContain, imagePosition = "" }) => {
    return (
        <Link
            href={href}
            className={`m-4 shadow-md h-96 rounded relative bg-white ${imageContain ? `bg-contain bg-no-repeat ${imagePosition}` : "bg-cover"} 
          ...
          `}
        >
            <div className="p-4 m-2 bg-white/80 rounded absolute bottom-0 dark:text-black">
